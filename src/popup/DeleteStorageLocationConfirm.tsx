import type { DeleteStorageLocationPopup } from "../types/storagelocation";

const DeleteStorageLocationConfirm = ({
  onConfirm,
  onCancel,
  storageLocationId,
  storageLocationName,
}: DeleteStorageLocationPopup) => {
  return (
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6">
          ...
          <p className="text-sm text-gray-500 text-center mb-6">
            The storage location will be permanently removed alongside{" "}
            <span className="text-red-500 font-bold">
              {" "}
              all associated inventory items. <br />
            </span>
...
export default DeleteStorageLocationConfirm;
