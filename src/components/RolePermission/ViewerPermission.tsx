    ...
    <div className="w-full h-[70vh] overflow-y-auto pr-6 ">
      ...
      <div className="flex items-end justify-between mt-4 border-b border-b-gray-400 pb-4">
        <div>
          ...
          <p className="font-normal text-gray-500 max-w-3/4">
            Users assigned the Viewer role can access warehouse information in
            read-only mode, enabling them to Browse all warehouses across the
            organization View detailed information about each warehouse.
          </p>
        </div>
        <div>
          <label className="relative inline-flex items-center cursor-pointer">
      ...
      <div className="flex items-end justify-between mt-4 border-b border-b-gray-400 pb-4">
        <div>
          ...
          <p className="font-normal text-gray-500 max-w-3/4">
            Users assigned the Viewer role can access stockmovements, orders and
            transfer records in read-only mode, allowing them to Browse all
            movement records View detailed information about each movement.
          </p>
        </div>
        <div>
          <label className="relative inline-flex items-center cursor-pointer">
      ...
      <div className="flex items-end justify-between mt-4 border-b border-b-gray-400 pb-4">
        <div>
          ...
          <p className="font-normal text-gray-500 max-w-3/4">
            Users assigned the Viewer role can access client and supplier
            information in read-only mode, enabling them to Browse all clients
            and suppliers View detailed information about each entity.
          </p>
        </div>
        <div>
          <label className="relative inline-flex items-center cursor-pointer">
      ...
      <div className="flex items-end justify-between mt-4 border-b border-b-gray-400 pb-4">
        <div>
          ...
          <p className="font-normal text-gray-500 max-w-3/4">
            Users assigned the Viewer role can access analytics and reporting
            features in read-only mode, allowing them to View dashboards and
            reports related to inventory performance, stock levels, and movement
            trends.
          </p>
        </div>
        <div>
