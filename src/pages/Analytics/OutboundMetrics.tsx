...
import OrdersShipped from "../../components/AnalyticsCharts/Outbound-Metrics/OrdersShipped";
import UnfulfilledOrder from "../../components/AnalyticsCharts/Outbound-Metrics/UnfulfilledOrder";
import OrderAccuracyRate from "../../components/AnalyticsCharts/Outbound-Metrics/OrderAccuracyRate";
        ...
        <div className="min-h-full p-6">
            ...
            <div className="mt-4 grid grid-cols-1 lg:grid-cols-3 gap-4 w-full">
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      Total number of orders shipped each month
                    </p>
                  </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 flex items-center justify-between">
                  <div>
                    <h3 className="text-sm text-gray-500">
                      Orders Accuracy Rate
                    </h3>
                    <div className="text-2xl font-bold text-gray-900">98%</div>
                    <div className="text-xs text-gray-400 mt-1">
                      Compared to 97% last month
                    </div>
                  </div>
                  <div className="w-14 h-14 flex items-center justify-center rounded-lg bg-linear-to-br from-blue-50 to-blue-100">
                    <svg
          ...
          <section className="mt-4 w-full flex gap-x-4">
            <div className="bg-white p-6 rounded-2xl shadow-sm w-1/2">
              <div className="flex justify-between items-center ">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Orders that could not be fulfilled on time
                  </p>
                </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm w-1/2">
              <div className="flex justify-between items-center ">
                <div>
                  <h1 className="font-semibold text-lg">Order Accuracy Rate</h1>
                  <p className="text-sm text-gray-500 mt-1">
                    Percentage of orders shipped without errors
                  </p>
                </div>
                <div className="flex border-gray-400 border rounded-lg overflow-hidden">
                  <button className="text-gray-700 border-gray-400 px-3 py-1 font-medium hover:bg-gray-300 cursor-pointer transition-all duration-200">
