        ...
        <div className="min-h-full p-6">
          <section className="mb-8">
            <div className="flex items-center justify-between">
              ...
              <div>
                <Link
                  className="flex items-center px-4 py-2 bg-linear-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer"
                  to="/salesorders/all"
                >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200/50 overflow-hidden w-full">
              <div className="px-6 py-4 border-b border-gray-200">
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Quick overview of recent Approved sales orders.
                </p>
              </div>
                        ...
                        <tr>
                          ...
                          <td className="px-6 py-4 text-sm text-gray-900">
                            <div className="flex items-center gap-x-2">
                              ...
                              <button className="text-blue-600 font-semibold hover:underline rounded-xl cursor-pointer">
                                Review Sales
                              </button>
                            </div>
                          </td>
